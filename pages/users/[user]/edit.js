...
const Edit = ({ user, params }) => {
    ...
    const onFinish = async (values) => {
        const request = await fetch(`https://gorest.co.in/public/v2/users/${params.user}`, {
            method: 'PUT',
    ...
    return (
        <Mylayout>
            <div className='bg-white flex justify-center py-8 px-16 text-left my-8'>
